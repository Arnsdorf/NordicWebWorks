...
$cases = [
    ...
    2 => [
        "title" => "CodeLearner",
        "description" => "Denne web butik tilbyder en bred vifte af kurser inden for 
        ...
        "features" => [
            ...
            "Brugerprofiler" => "Brugerne kan oprette konti, gemme deres kurser, følge deres fremskridt og få adgang til opdateringer og nye kurser.",
        ],
        "techTags" => [".Bootstrap", ".MySQL", ".PHP"]
    ]
];
