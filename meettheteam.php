    ...
    <div class="container">
        <div class="row d-flex justify-content-center">
            <div class="col-lg-8 col-md-10 px-4 p-md-4">
                ...
                <p class="text-black">
                    Nordic Web Works består af et dedikeret team af eksperter, der kombinerer kreativitet,
                    teknisk dygtighed og innovation. Vi fokuserer på at udvikle brugervenlige og visuelt
                    engagerende løsninger, hvor design og teknologi mødes i sammenspil. Vores værdier bygger på
                    samarbejde, kvalitet og en konstant stræben efter at skabe stærke brugeroplevelser,
                    der både inspirerer og leverer resultater. Holdet er altid klar på nye eventyr.
                </p>
