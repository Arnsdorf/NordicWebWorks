...
<!-- Navbar -->
<nav class="navbar navbar-expand-md bg-nav border-bottom-gray z-1 navbar-blur">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse text-center justify-content-end" id="navbarNav">
            <ul class="navbar-nav ms-auto align-items-center mx-md-4">
                <li class="nav-item">
                    <a class="nav-link text-white mx-2" href="index.php"><span class="fw-bold">HJEM</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white mx-2" href=""><span class="fw-bold">SERVICES</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white mx-2" href="moedholdet.php"><span class="fw-bold">MØD HOLDET</span></a>
                </li>
                <li class="nav-item">
