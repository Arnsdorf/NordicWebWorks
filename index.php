...
<div class="container-fluid bg-front">
    <div class="row">
            ...
            <div class="position-absolute bottom-0 ps-4 d-none d-md-block ">
                    <div class="scroll-animate"><i class="bi bi-instagram social " style="font-size: 1.4rem"></i></div>
                    <div class="mt-3 scroll-animate"><i class="bi bi-linkedin social" style="font-size: 1.4rem"></i></div>
                    <div class="mt-3 scroll-animate"><i class="bi bi-twitter social" style="font-size: 1.4rem"></i></div>
                    <div class="mt-3 mb-3 scroll-animate"><i class="bi bi-facebook social" style="font-size: 1.4rem"></i></div>
            </div>
            <!-------Boxes--------------->
            ...
            <div class="ms-13 scroll-animate">
                ...
                <div class="d-flex justify-content-end m-0 p-0 position-relative">
                    <div class="position-absolute d-none d-md-block">
                        <h6 class="text-white-50 fw-light" style="letter-spacing: 0.2rem;writing-mode: vertical-rl;font-family: 'Source Code Pro'">UX-UI</h6>
                        <h6 class="text-white-50 fw-light mb-5 mt-5" style="letter-spacing: 0.2rem;writing-mode: vertical-rl;font-family: 'Source Code Pro'">Development</h6>
                        <h6 class="text-white-50 fw-light " style="letter-spacing: 0.2rem;writing-mode: vertical-rl;font-family: 'Source Code Pro'">Design</h6>
                     <a href="#services"><div class="arrow-box ms-4 mt-5 d-flex align-items-center justify-content-center"><div class="arrow "></div></div></a>
                    </div>
                </div>
...
<!-------services---------------------------------->
<section class="pt-5 mt-2 bg-custom-dark" id="services">
    <div class="container">
    ...
    <div class="container-fluid m-0 p-0 mb-5">
        <div class="row p-0 m-0 justify-content-center">
            <div class="mt-5 ">
                ...
                <h2 class="text-white mt-5 mb-4 font-case col-12 d-md-none scroll-animate ps-3" style="font-size: 2rem"> <span class="fw-light text-white-50" style="font-size: 1rem">Intreasseret i vores erfaringer?</span> <br> Tjek vores <span class="text-purple">tidligere projekter</span> ud!</h2>
            </div>


            <div class="col-lg-3 col-4 p-0 mt-2 me-2 scroll-animate">
                <a class="" href="caseinfo.php"><div class="position-relative img-box">
                    ...
                    <div class="custom-overlay d-flex">
                        <div class="overlay-content">
                            ...
                            <div class="project-date">2024-08-20</div>
                        </div>
                    </div>
                </div></a>
            </div>

            <div class="col-lg-6 col-6 p-0 mt-2 scroll-animate">
                <a class="" href="caseinfo.php"><div class="position-relative img-box">
            ...
            <div class="col-lg-5 col-7 p-0 me-2 scroll-animate">
                <a class="" href="caseinfo.php"><div class="position-relative img-box">
                        <div class="bg-white mt-2 mason-drip d-none" style="height: 17rem"></div>
            ...
            <div class="col-lg-4 col-3 p-0 scroll-animate">
                <a class="" href="caseinfo.php"><div class="position-relative img-box">
                        <div class="bg-white mt-2 mason-drip d-none" style="height: 17rem"></div>
            ...
            <div class="col-lg-4 col-4 p-0 me-2 scroll-animate">
                <a class="" href="caseinfo.php"><div class="position-relative img-box">
                        <div class="bg-white mt-2 mason-drip d-none" style="height: 17rem"></div>
            ...
            <div class="col-lg-5 col-6 p-0 scroll-animate">
                <a class="" href="caseinfo.php"><div class="position-relative img-box">
                        <div class="bg-white mt-2 mason-drip d-none" style="height: 17rem"></div>
