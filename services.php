        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3 mb-4 d-flex justify-content-center">
                    <div class="card card-hover bg-cases h-100">
                        <div class="card-body text-white d-flex flex-column">
                            <div>
                                <img style="width: 40px" class="shadow mb-3" src="uploads/icons/coding.png" alt="coding">
                ...
                <div class="col-md-6 col-lg-3 mb-4 d-flex justify-content-center">
                    <div class="card card-hover bg-cases h-100">
                        <div class="card-body text-white d-flex flex-column">
                            <div>
                                <img style="width: 40px" class="shadow mb-3" src="uploads/icons/interface.png" alt="coding">
                ...
                <div class="col-md-6 col-lg-3 mb-4 d-flex justify-content-center">
                    <div class="card card-hover bg-cases h-100">
                        <div class="card-body text-white d-flex flex-column">
                            <div>
                                <img style="width: 40px" class="shadow mb-3" src="uploads/icons/api.png" alt="coding">
